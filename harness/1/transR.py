...
# -*- coding: utf-8 -*-
# @Date        : 2022-05-12
# @Author      : Eashan & Chaitanya
# @Resource    : http://sdcs.sysu.edu.cn
...
if __name__ == "__main__":
    ...
    filename = f'{args.dataset}_TransR.ckpt'
    ...
    for epoch in range(config.train_times):
        ...
        # Save to file
        to_file = f'{epoch+1},{total_loss.item()},{losses},{hit10},{meanrank}'
        file_path = fr'./result/{args.dataset}/{filename}_train_log.csv'
        f = open(file_path, 'a+')
        f.write(to_file)
        f.write('\n')
